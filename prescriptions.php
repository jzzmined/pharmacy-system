                ...
                <div id="rxStep1">
                    <div class="rx-body">
                        ...
                        <div class="rx-patient-card">
                            ...
                            <div class="rx-field">
                                <input type="text" class="rx-input" id="ptName" placeholder="Full name"
                                    autocomplete="off">
                            </div>
                            <div class="rx-field">
                ...
                <div id="rxStep2" style="display:none">
                    <div class="rx-review-wrap">
                        ...
                        <div class="rx-review-card">
                            ...
                            <div class="review-row"><span class="review-key">Full Name</span> <span class="review-value"
                                    id="rv-name">—</span></div>
                            <div class="review-row"><span class="review-key">Age</span> <span class="review-value"
                                    id="rv-age">—</span></div>
