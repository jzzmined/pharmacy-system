                ...
                <div class="invoices-card">
                    ...
                    <div class="invoices-toolbar">
                        ...
                        <div class="invoices-controls">
                            <input class="inv-search" id="invSearch" type="text" placeholder="Search…"
                                autocomplete="off">
                            ...
                            <tbody id="invBody">
                                ...
                                <?php else: ?>
                                    <?php foreach ($invoices as $r): ?>
                                        <tr data-inv="<?= strtolower('TXN-' . fmtPad($r['InvoiceID'])) ?>"
                                            ...
                                            <td><span class="inv-status completed">Completed</span></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tbody>
